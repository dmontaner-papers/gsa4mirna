...
.job$dir$proces      <- file.path (.job$dir$data, "data_processed_godard")

.job$dir$plots  <- file.path (.job$dir$data, "results_godard", "plots")
.job$dir$res    <- file.path (.job$dir$data, "results_godard", "files")
