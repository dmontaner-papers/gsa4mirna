...
hc <- hclust (distancia)
png (filename ="cluster_corelationd_bp_paired.png",   width = 480 * x.por, height = 480 * y.por)
...
he <- hclust (distancia)
png (filename = "cluster_euclideand_bp_paired.png", width = 480 * x.por, height = 480 * y.por)
...
distancia <- as.dist ((1 - correlacion) / 2)
hc <- hclust (distancia)
png (filename ="cluster_corelationd_cc_paired.png",   width = 480 * x.por, height = 480 * y.por)
...
he <- hclust (distancia)
png (filename = "cluster_euclideand_cc_paired.png", width = 480 * x.por, height = 480 * y.por)
...
distancia <- as.dist ((1 - correlacion) / 2)
hc <- hclust (distancia)
png (filename ="cluster_corelationd_mf_paired.png",   width = 480 * x.por, height = 480 * y.por)
...
he <- hclust (distancia)
png (filename = "cluster_euclideand_mf_paired.png", width = 480 * x.por, height = 480 * y.por)
