...
.job$dir$rawdat      <- file.path (.job$dir$data, "data_raw_expression")
.job$dir$annotation  <- file.path (.job$dir$data, "data_annotation")
.job$dir$proces      <- file.path (.job$dir$data, "data_processed_expression")

.job$dir$plots  <- file.path (.job$dir$data, "results_expression", "plots")
.job$dir$res    <- file.path (.job$dir$data, "results_expression", "files")
