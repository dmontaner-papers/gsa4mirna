...
.job$dir$proces      <- file.path (.job$dir$data, "data_processed_permutation")

.job$dir$plots  <- file.path (.job$dir$data, "results_permutation", "plots")
.job$dir$res    <- file.path (.job$dir$data, "results_permutation", "files")
